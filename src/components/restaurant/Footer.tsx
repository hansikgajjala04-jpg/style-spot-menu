        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#reservation" className="text-primary-foreground/80 hover:text-accent transition-colors">Reservations</a></li>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href="#"
                  className="text-primary-foreground/80 hover:text-accent transform hover:scale-110 transition-all duration-300"
        ...
        <div className="border-t border-primary-foreground/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-primary-foreground/60">
              © {currentYear} Bistro Élégant. All rights reserved.
            </p>
